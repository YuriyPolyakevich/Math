...
//| 1 3 6 10
//
//Each cell can be represented as points (x, y), with x
//being the distance from the vertical wall, and y being the height from the ground.
//
//For example, the bunny worker at (1, 1) has ID 1,
//the bunny worker at (3, 2) has ID 9, and the bunny worker at (2,3) has ID 8.
...
public class BunnyWorkerLocations {
    ...
    public static String solution(long x, long y) {
        // a_1 = formula of a_n triangle element
        // formula of arithmetic progression of the second order
        return String.valueOf((x * (x + 1)) / 2 + ((y - 1) * x) + ((y - 1) * (y - 2)) / 2);
    }
